...
Start-Process powershell.exe -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command cd '$currentScriptDirectory\AuthService'; ./mvnw spring-boot:run"
...
# Navigate to the fourth Spring microservice directory
